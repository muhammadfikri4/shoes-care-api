...
export const createRackRepo = async (data: { code: string; name?: string; location?: string; status?: RackStatus }) =>
...
export const updateRackRepo = async (
  id: string,
  data: Partial<{ code: string; name?: string; location?: string; status?: RackStatus }>
